...
def fit_continuous(img, histogram=True, left_fit=None, right_fit=None, left_lane=None, right_lane=None):
    if histogram==True:
        hist_img, left_fit, right_fit, left_lane, right_lane = fit_histogram(img)
...
def fit_lane(img):
    hist_img, left_fit, right_fit, left_lane_inds, right_lane_inds = fit_histogram(img)
...
def plot_continuous(img):
    #fit plotting
    left_fitx, right_fitx, left_lane_inds, right_lane_inds = fit_continuous(img.copy())
